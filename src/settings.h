...
namespace Settings
{
    ...
    namespace Patches
    {
        ...
        static REX::TOML::Bool bEditorIdCache("Patches", "bEditorIdCache", true);
    ...
    static void Load()
    {
        ...
        toml->Init(
            "Data/skse/plugins/SSEEngineFixesForWine.toml",
            "Data/skse/plugins/SSEEngineFixesForWineCustom.toml");
        toml->Load();
    }
}